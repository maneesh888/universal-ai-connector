...
import com.myadidi.universalai.connector.contract.UniversalAiCapabilitySupportState
...
class P2HContractHarnessTests {
    ...
    fun capabilityStatesKeepAbsentAndExplicitUnknownDistinct() {
        ...
        val capabilities =
            com.myadidi.universalai.connector.contract.json.CanonicalJson.decode(
