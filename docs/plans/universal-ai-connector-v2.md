...
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, P3-A HTTP transport construction and lifecycle foundation, P3-B transport policy, and P3-C SSE and response metadata
- Active work package: P3-D provider registry
...
| P3 | HTTP transport and provider registry | In progress | P3-A through P3-C completed; P3-D active |
