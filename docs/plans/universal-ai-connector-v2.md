...
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, P3-A HTTP transport construction and lifecycle foundation, and P3-B transport policy
