...
- Repository stage: P4 OpenAI Responses adapter completed; P5 Anthropic adapter active at P5-C; P6 OpenRouter and OpenAI-compatible adapters deferred after P6-B
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, completed P3 provider-neutral transport foundation, completed P4 OpenAI Responses adapter, completed P5-A/P5-B Anthropic foundations and P6-A/P6-B OpenRouter packages, plus P5-C governed Anthropic structured-output translation and revalidation, complete documented error/incomplete mapping, conservative capabilities, deterministic fixtures, and targeted live smokes in this candidate; Anthropic streaming and lifecycle closeout and generic OpenAI-compatible runtime behavior remain unimplemented
- Active work package: P5-C structured output, errors, and capabilities in this candidate; P5-D remains deferred until P5-C becomes authoritative
...
- P5-C activation: the authoritative P5-B base activates governed Anthropic structured output, complete documented error and incomplete-response mapping, conservative capabilities, deterministic coverage, and the required structured-output and intentional-error live smokes without claiming P5-D or P5-E behavior
...
- P6-B completion authority: the transition is accepted only after the exact-head deterministic, OpenAI, and OpenRouter live gates, ordinary CI, secretless live-policy status, independent review, and guarded merge pass; those self-referential identifiers belong in the pull-request brief
...
| P5 | Anthropic adapter | In progress | P5-A and P5-B are authoritative; P5-C structured output, errors, capabilities, and targeted live smokes are completed in this candidate; P5-D and P5-E remain incomplete |
| P6 | OpenRouter and OpenAI-compatible adapters | Deferred | P6-A readiness and P6-B direct non-streaming OpenRouter behavior completed; P6-C not activated while P5 is active |
...
available, so P5-B resumed and became authoritative through PR #42. P5-C is now the active package
and P6 remains deferred after P6-B.
