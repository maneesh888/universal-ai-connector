...
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, and P3-A HTTP transport construction and lifecycle foundation
- Active work package: P3-B URL, header, timeout, and redaction policy
...
| P3 | HTTP transport and provider registry | In progress | P3-A completed; P3-B active |
