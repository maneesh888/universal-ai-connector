...
- Repository stage: P4 OpenAI Responses adapter completed; P5 Anthropic adapter active at P5-D; P6 OpenRouter and OpenAI-compatible adapters deferred after P6-B
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, completed P3 provider-neutral transport foundation, completed P4 OpenAI Responses adapter, authoritative P5-A through P5-C Anthropic behavior and P6-A/P6-B OpenRouter packages, plus P5-D incremental Anthropic streaming translation, terminal arbitration, cancellation coverage, and targeted live smokes in this candidate; Anthropic lifecycle closeout and generic OpenAI-compatible runtime behavior remain unimplemented
- Active work package: P5-D streaming translation and cancellation in this candidate; P5-E remains deferred until P5-D becomes authoritative
...
- P5-D activation: the authoritative P5-C base activates incremental Anthropic SSE translation, bounded stream state, terminal arbitration, active cancellation, deterministic fixtures, and the required streaming and active-cancellation live smokes without claiming P5-E lifecycle closeout
...
| P5 | Anthropic adapter | In progress | P5-A through P5-C are authoritative; P5-D streaming, cancellation, and targeted live smokes are completed in this candidate; P5-E remains incomplete |
...
through PR #48, P5-D is now the active package, and P6 remains deferred after P6-B.
