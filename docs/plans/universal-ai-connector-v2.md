...
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, P3-A HTTP transport construction and lifecycle foundation, and P3-B URL, header, timeout, and redaction policy
- Active work package: P3-C SSE and response metadata
...
| P3 | HTTP transport and provider registry | In progress | P3-A and P3-B completed; P3-C active |
