...
- Current implementation: the accepted P1 host baseline, P2 canonical-contract baseline, completed P3 provider-neutral transport foundation, completed P4 OpenAI Responses adapter, completed P5-A protocol and authentication-test readiness, completed P6-A OpenRouter protocol/configuration readiness, and completed P6-B direct OpenRouter non-streaming adapter and local-live route in this candidate; no Anthropic or generic OpenAI-compatible runtime adapter exists yet
- Active work package: none; P6-C generic OpenAI-compatible construction and translation remains `Not started`
...
| P6 | OpenRouter and OpenAI-compatible adapters | In progress | P6-A readiness and P6-B direct non-streaming OpenRouter behavior completed in this candidate; P6-C not activated |
